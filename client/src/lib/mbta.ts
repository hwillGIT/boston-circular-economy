...
const MBTA_STATIONS: MBTAStation[] = [
  // Orange Line
  { name: 'Oak Grove', lat: 42.4368, lng: -71.071, line: 'orange' },
  { name: 'Malden Center', lat: 42.4267, lng: -71.074, line: 'orange' },
  { name: 'Wellington', lat: 42.4024, lng: -71.077, line: 'orange' },
  { name: 'Assembly', lat: 42.3926, lng: -71.0773, line: 'orange' },
  { name: 'Sullivan Square', lat: 42.384, lng: -71.077, line: 'orange' },
  ...
  { name: 'Stony Brook', lat: 42.317, lng: -71.1042, line: 'orange' },
  ...
  { name: 'Ashmont', lat: 42.284, lng: -71.0641, line: 'red' },
  ...
  { name: 'Government Center', lat: 42.3594, lng: -71.059, line: 'green' },
  ...
  { name: 'Hynes Convention Center', lat: 42.3472, lng: -71.087, line: 'green' },
  ...
  { name: 'Coolidge Corner', lat: 42.342, lng: -71.1232, line: 'green' },
  ...
  { name: 'East Somerville', lat: 42.38, lng: -71.087, line: 'green' },
  ...
  { name: 'Suffolk Downs', lat: 42.3903, lng: -70.997, line: 'blue' },
  { name: 'Orient Heights', lat: 42.3868, lng: -71.0047, line: 'blue' },
  { name: 'Wood Island', lat: 42.3797, lng: -71.023, line: 'blue' },
  ...
  { name: 'Government Center', lat: 42.3594, lng: -71.059, line: 'blue' },
  { name: 'Bowdoin', lat: 42.3614, lng: -71.062, line: 'blue' },

  // Mattapan Trolley
  { name: 'Ashmont', lat: 42.284, lng: -71.0641, line: 'mattapan' },
