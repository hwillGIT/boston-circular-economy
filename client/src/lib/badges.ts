...
export const BADGES: Badge[] = [
  { id: 'first_action', name: 'First Step', description: 'Log your first activity', emoji: '🌱', threshold: 1, category: 'items' },
  { id: 'five_items', name: 'Getting Started', description: 'Divert 5 items', emoji: '⭐', threshold: 5, category: 'items' },
  { id: 'ten_items', name: 'Eco Warrior', description: 'Divert 10 items', emoji: '🏅', threshold: 10, category: 'items' },
  { id: 'twenty_five', name: 'Community Hero', description: 'Divert 25 items', emoji: '🚀', threshold: 25, category: 'items' },
  { id: 'fifty_items', name: 'Circular Champion', description: 'Divert 50 items', emoji: '👑', threshold: 50, category: 'items' },
  { id: 'hundred_items', name: 'Legend', description: 'Divert 100 items', emoji: '🌟', threshold: 100, category: 'items' },
  { id: 'week_streak_4', name: 'Consistent', description: '4 week eco-streak', emoji: '🔥', threshold: 4, category: 'streak' },
  { id: 'week_streak_12', name: 'Dedicated', description: '12 week eco-streak', emoji: '🌋', threshold: 12, category: 'streak' },
  { id: 'co2_50', name: 'Carbon Cutter', description: 'Prevent 50 lbs CO₂', emoji: '🌍', threshold: 50, category: 'co2' },
  { id: 'repairer', name: 'Fix-It Pro', description: 'Log 5 repairs', emoji: '🔧', threshold: 5, category: 'special' },
];
 ...
 */
export function getNextBadge(items: number, co2: number, repairs: number): { badge: Badge, progress: number, total: number } | null {
  const streak = getStreakData().longestStreak;
