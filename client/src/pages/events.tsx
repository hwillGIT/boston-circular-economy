      ...
      <div className="dashboard-content">
        ...
        <div className="dashboard-empty">
          ...
          <p className="dashboard-empty-sub">
            Community events and campaigns are being built. Local businesses will be able to host
            repair cafés, special events, swap meets, and more. Stay tuned!
          </p>
          ...
          >
            {[
              ...
              { emoji: '👕', title: 'Swap Meets', desc: 'Clothing and gear exchange events' },
              {
                ...
                desc: 'Community volunteer and outreach events',
              },
              ...
              >
                ...
                <h4 style={{ margin: '0 0 var(--space-1)', color: 'var(--text-primary)' }}>
                  {item.title}
                </h4>
                <p
