...
2. **API Restrictions**: Limit the API key so it can ONLY invoke _Maps JavaScript API_. Do not use the same key for Places/Routes web services on the client side.
