...
- *Inspired by: Google Maps, Airbnb*
...
- *Inspired by: Strava (1-tap), Olio (<30s), Too Good To Go (3-tap)*
...
- *Inspired by: HomeAdvisor badges, Nextdoor verified addresses, TaskRabbit guarantees*
...
- *Inspired by: Too Good To Go equivalencies, Strava streaks, Olio Karma tiers*
...
- *Inspired by: Google Maps bottom sheet (peek → half → full)*
...
- *Inspired by: Buy Nothing values commitment, Nextdoor neighbor tone, Olio karma*
...
- *Interaction:* Hover cards get `md → lg` transition.
